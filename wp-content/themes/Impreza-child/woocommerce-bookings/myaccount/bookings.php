	...
	foreach ( $tables as $table ) :
		...
		<table class="shop_table shop_table_responsive my_account_bookings">
			...
			foreach ( $table['bookings'] as $booking ) :
				...
				<?php if ( !$cancellable && $booking->get_status() !== 'cancelled' ) : ?>
					<tr>
						<td colspan="7">
							<p style="text-align:left;font-size:0.9rem;">Due to our cancellation policy of a minimum of 48 hours notice, this session cannot be cancelled. Please call us at (212) 353-0595 if you need assistance with this matter.</p>
						</td>
					</tr>
				<?php endif; ?>
			<?php endforeach; ?>
