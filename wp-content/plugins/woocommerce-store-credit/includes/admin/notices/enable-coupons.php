...
<div class="notice notice-warning">
	<p>
		<strong><?php esc_html_e( 'Store Credit for WooCommerce', 'woocommerce-store-credit' ); ?></strong> &#8211; <?php echo esc_html_x( 'WooCommerce coupons are not enabled.', 'admin notice', 'woocommerce-store-credit' ); ?>
