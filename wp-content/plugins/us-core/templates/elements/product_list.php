...
if (
	...
	if ( ! empty( $query_args['post__in'] ) ) {
		$query_args['post__in'] = array_diff( $query_args['post__in'], array( $current_object_id ) );
	} else {
...
if ( $orderby == 'custom' AND ! empty( $orderby_custom_field ) ) {
	$orderby = $orderby_custom_type ? 'meta_value_num' : 'meta_value';
...
// Order by Price
if ( isset( $query_args['orderby'] ) AND $query_args['orderby'] == 'price' ) {
	$query_args['orderby'] = 'meta_value_num';
	$query_args['meta_key'] = '_price';
}

// Order by Total Sales
if ( isset( $query_args['orderby'] ) AND $query_args['orderby'] == 'total_sales' ) {
	$query_args['orderby'] = 'meta_value_num';
	$query_args['meta_key'] = 'total_sales';
}

// Order by Rating
if ( isset( $query_args['orderby'] ) AND $query_args['orderby'] == 'rating' ) {
	$query_args['orderby'] = 'meta_value_num';
