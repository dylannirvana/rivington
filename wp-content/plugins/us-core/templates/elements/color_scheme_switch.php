...
if ( ! $us_color_scheme_switch_is_used AND $color_scheme ) {
	...
	// If the cookie exists, add the specific class to the <html> tag
	if ( ! empty( $_COOKIE['us_color_scheme_switch_is_on'] ) ) {
		$scheme_output .= '<script>document.documentElement.classList.add("us-color-scheme-on");</script>';
	}
