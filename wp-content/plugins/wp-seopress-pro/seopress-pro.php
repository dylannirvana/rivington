...
//Define
///////////////////////////////////////////////////////////////////////////////////////////////////
define('SEOPRESS_PRO_VERSION', '8.2');
...
if (file_exists(__DIR__ . '/vendor/autoload.php') && file_exists(WP_PLUGIN_DIR . '/wp-seopress/seopress-autoload.php')) {
    ...
    if ('8.2' !== $versionFree && version_compare($versionFree, '4.5.1', '<=')) {
        return;
    }
...
<div class="<?php echo $class; ?>">
    <p>
        <?php echo wp_kses_post(sprintf(__('A new <strong>SEOPress PRO</strong> update (v%1$s) is available (current installed version %2$s). <br>Please update now to get new features and prevent any issues.', 'wp-seopress-pro'), '<code>8.2</code>', '<code>' . esc_attr(SEOPRESS_PRO_VERSION) . '</code>')); ?>
    </p>
    <p>
