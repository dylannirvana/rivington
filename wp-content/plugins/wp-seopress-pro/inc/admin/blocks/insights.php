                            ...
                            <div class="seopress-tools-card">
                                <?php
                                    if (empty($google_api_key)) {
                                        ...
                                        ?>
                                        <p>
                                            <?php _e('You need to login to Google Search Console to get your data.', 'wp-seopress-pro'); ?>
                                        </p>

                                        <p>
                                            <a class="<?php if ('index.php' == $pagenow) { echo 'button'; } else { echo 'seopress-btn'; }; ?>" href="<?php echo admin_url('admin.php?page=seopress-pro-page#tab=tab_seopress_inspect_url'); ?>">
