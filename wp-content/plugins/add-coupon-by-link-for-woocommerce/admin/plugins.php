...
class pisol_acblw_other_plugins{
    ...
    function tab(){
        ...
        <a class="ml-auto mr-0 px-3 text-light d-flex align-items-center  border-left border-right bg-danger" href="https://wordpress.org/support/plugin/add-coupon-by-link-for-woocommerce/reviews/#bbp_topic_content" target="_blank">
        SEND SUGGESTIONS TO IMPROVE
        </a>
        <?php
    }
