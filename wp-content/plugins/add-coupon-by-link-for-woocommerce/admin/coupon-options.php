...
class pisol_acblw_coupon_options{
    ...
    function add_coupon_text_field($coupon_id, $coupon) {
        ...
        <p class="form-field">
					...
					<?php echo wp_kses_post( wc_help_tip( esc_html__( 'Products that will be auto added to the cart when user visit URL coupon link', 'add-coupon-by-link-woocommerce' ) ) ); ?>
		</p>
        <?php
    }
