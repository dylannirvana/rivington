	...
	public static function welcome_notice() {
		...
		<p class="sw-welcome-text">
			<?php
				...
				echo wp_kses_post( sprintf( __( 'Thank you for installing <strong>Woo Gift Cards</strong>. Ready to start selling and accepting gift cards? <a href="%s">Click here to create your first gift card product</a>.', 'woocommerce-gift-cards' ), admin_url( 'post-new.php?post_type=product&tutorial=true&tutorial_type=gift-card' ) ) );
			?>
		</p>
		<?php
